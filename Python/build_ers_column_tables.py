...
USED_FOR = {
    ...
    'WINDOWCODE':      'Windows_Change flag (code present + different pre/post); Windows_Partial requires it unchanged',
    'NUMWINESTAR':     'Windows_Partial flag (ENERGY STAR window count rose, code unchanged)',
